...
namespace Pwa.FrameWork.Dao.EF.Smart1662
{
    ...
    public partial class sp_GetIncident_GetByColumn_Result
    {
        public Nullable<int> id { get; set; }
        public Nullable<int> Expr1 { get; set; }
        public int PwaIncidentID { get; set; }
        public string PwaIncidentNo { get; set; }
        public int PwaIncidentTypeID { get; set; }
        public int PwaIncidentGroupID { get; set; }
        public int CaseTitle { get; set; }
