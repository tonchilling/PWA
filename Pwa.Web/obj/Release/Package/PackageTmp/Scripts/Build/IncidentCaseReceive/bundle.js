            ...
            search: function (e, t, n, a, d, r) {
                ...
                PwaManager.PwaWaiting(!0), $.ajax({
                    ...
                    success: function (e) {
                        ...
                        t += "    <thead>", t += "            <tr>", t += '                <th class="" scope="col">วันเวลาที่รับแจ้ง</th>', t += '                <th class="" scope="col">เลขที่รับแจ้ง</th>', t += '                <th class="" scope="col">รายละเอียด</th>', t += "                        </thead>", t += "            <tbody>", null != e.Result && null != e.Result.Incidents && e.Result.Incidents.length > 0 && $.each(e.Result.Incidents, (function (e, n) {
                            ...
                            null != t.CaseLatitude && "" != t.CaseLatitude && null != t.CaseLongtitude && "" != t.CaseLongtitude && L.marker([1 * t.CaseLatitude, 1 * t.CaseLongtitude]).addTo(map).bindPopup("<b>เลขที่รับแจ้ง :  ".concat(t.PwaIncidentNo, "</b><br /><b>สาเหตุ :  ").concat(t.RequestCategory, "</b><br /><b>รายละเอียด :  ").concat(t.RequestCategorySubject, "</b>")).openPopup()
                        }))
                    }
                })
            }
