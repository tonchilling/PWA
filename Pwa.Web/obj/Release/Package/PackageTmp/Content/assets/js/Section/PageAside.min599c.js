...
! function (global, factory) {
    if ("function" == typeof define && define.amd) define("/Section/PageAside", ["exports", "jquery", "Component"], factory);
    else if ("undefined" != typeof exports) factory(exports, require("jquery"), require("Component"));
    else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jQuery, global.Component), global.SectionPageAside = mod.exports
    }
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        _class = function (_Component) {
            function _class() {
                ...
                return _this.$scroll = _this.$el.find(".page-aside-scroll"), _this.scrollable = _this.$scroll.asScrollable({
                    namespace: "scrollable",
                    contentSelector: "> [data-role='content']",
                    containerSelector: "> [data-role='container']"
                }).data("asScrollable"), _this
            }
            return babelHelpers.inherits(_class, _Component), babelHelpers.createClass(_class, [{
                key: "process",
                value: function () {
                    var _this2 = this;
                    ($BODY.is(".page-aside-fixed") || $BODY.is(".page-aside-scroll")) && this.$el.on("transitionend", function () {
                        _this2.scrollable.update()
                    }), Breakpoints.on("change", function () {
                        var current = Breakpoints.current().name;
                        $BODY.is(".page-aside-fixed") || $BODY.is(".page-aside-scroll") || ("xs" === current ? (_this2.scrollable.enable(), _this2.$el.on("transitionend", function () {
                            _this2.scrollable.update()
                        })) : (_this2.$el.off("transitionend"), _this2.scrollable.update()))
                    }), (0, _jquery2.default)(document).on("click.pageAsideScroll", ".page-aside-switch", function () {
                        _this2.$el.hasClass("open") ? _this2.$el.removeClass("open") : (_this2.scrollable.update(), _this2.$el.addClass("open"))
                        ...
                        "site-navbar-collapse" === (0, _jquery2.default)(target).attr("id") && _this2.scrollable.update()
                    })
                }
            }]), _class
        }(_Component3.default);
