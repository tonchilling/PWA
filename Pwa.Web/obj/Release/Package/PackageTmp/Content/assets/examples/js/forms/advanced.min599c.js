...
! function (global, factory) {
    if ("function" == typeof define && define.amd) define("/forms/advanced", ["jquery", "Site"], factory);
    else if ("undefined" != typeof exports) factory(require("jquery"), require("Site"));
    else {
        var mod = {
            exports: {}
        };
        factory(global.jQuery, global.Site), global.formsAdvanced = mod.exports
    }
    ...
    (0, _jquery2.default)(document).ready(function ($) {
    ...
    }), (0, _jquery2.default)("#inlineDatepicker").datepicker(), (0, _jquery2.default)("#inlineDatepicker").on("changeDate", function (event) {
        ...
        function () {
            ...
            /\S+@\S+\.\S+/.test(e.attrs.value) || (0, _jquery2.default)(e.relatedTarget).addClass("invalid")
        ...
        function () {
            ...
            cities.initialize();
            var options = _jquery2.default.extend(!0, {}, Plugin.getDefaults("tagsinput"), {
                itemValue: "value",
                itemText: "text",
                typeaheadjs: [{
                    hint: !0,
                ...
                $input = (0, _jquery2.default)("#inputTagsObject");
        ...
        function () {
            ...
            var options = _jquery2.default.extend(!0, {}, Plugin.getDefaults("tagsinput"), {
                ...
                $input = (0, _jquery2.default)("#inputTagsCategorizing");
            $input.tagsinput(options), $input.tagsinput("add", {
                value: 1,
                text: "Amsterdam",
                continent: "Europe"
        ...
        }(), (0, _jquery2.default)(".multi-select-methods").multiSelect(), (0, _jquery2.default)("#buttonSelectAll").click(function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("select_all"), !1
        }), (0, _jquery2.default)("#buttonDeselectAll").click(function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("deselect_all"), !1
        }), (0, _jquery2.default)("#buttonSelectSome").click(function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("select", ["Idaho", "Montana", "Arkansas"]), !1
        }), (0, _jquery2.default)("#buttonDeselectSome").click(function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("select", ["Idaho", "Montana", "Arkansas"]), !1
        }), (0, _jquery2.default)("#buttonRefresh").on("click", function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("refresh"), !1
        }), (0, _jquery2.default)("#buttonAdd").on("click", function () {
            return (0, _jquery2.default)(".multi-select-methods").multiSelect("addOption", {
                value: 42,
                text: "test 42",
                index: 0
            }), !1
                ...
                minLength: 1
                    ...
                    source: function (strs) {
                        return function (q, cb) {
                            ...
                            matches = [], substrRegex = new RegExp(q, "i"), _jquery2.default.each(strs, function (i, str) {
